...
class WebChatModel(ChatModel):
    def __init__(
        ...
        if (
            ...
            super().__init__(
                dict(model_name_or_path=model_name_or_path, template=template)
            )
    ...
    def predict(
        ...
        Tuple[Sequence[Tuple[str, str]], Sequence[Tuple[str, str]]], None, None
    ]:
        ...
        for new_text in self.stream_chat(
            ...
            if isinstance(result, tuple):
                ...
                output_messages = query_messages + [
