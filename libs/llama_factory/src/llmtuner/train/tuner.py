...
from .dpo_extrapolate import run_dpo_extrapolate
from .rm_extrapolate import run_rm_extrapolate
...
def run_exp(
    ...
    elif finetuning_args.stage == "rm_extrapolate":
        run_rm_extrapolate(
    ...
    elif finetuning_args.stage == "dpo_extrapolate":
        run_dpo_extrapolate(
            model_args, data_args, training_args, finetuning_args, callbacks
        )
    else:
