...
def patch_config(
    ...
    if not is_deepspeed_zero3_enabled():
        ...
        if init_kwargs["low_cpu_mem_usage"]:
            ...
            ):  # quant models cannot use auto device map
                init_kwargs["device_map"] = model_args.device_map or {
                    "": get_current_device()
                }
...
def patch_model(
    ...
    if (
        getattr(model.config, "model_type", None) == "mixtral"
