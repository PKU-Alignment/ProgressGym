...
Those algorithms are instantialized here by the *Examinee* class. For each alignment algorithm, you have to (and we have already) implement a sub-class of the base *Examinee* Class. You should specify the extra (from those stored in the base *Examinee* class) information it stores and, most importantly, how it interacts with the *Judge* class at each time step.
