...
def list_duplicates_in_mirror(
    ...
    """
    dups_list = []
    print("listing duplicates in mirror...")
    for dirName, subdirList, fileList in tqdm(list(os.walk(mirror_dir))):
...
def populate_raw_from_mirror(
    mirror_dir=None, raw_dir=None, overwrite=False, dups_list=None, quiet=False
):
    """
