...
if __name__ == "__main__":
    ...
    # raw folder
    parser.add_argument(
        "-r", "--raw", help="Path to the raw-folder", default="data/raw/", type=str
    )
    # text folder
    parser.add_argument(
        "-ote",
    ...
    # log file
    parser.add_argument(
        "-l", "--log_file", help="Path to log file", default=".log", type=str
    )
